...
- `.Rmd` files are located in the `Empirical_Seminar_25-26/` folder  
- CSV/data files are located in the `data/` folder  

You can use the `.Rmd` files to regenerate the HTML outputs locally with your own datasets.

---

## Notes

- All HTML files are rendered using **R Markdown** and are viewable in any modern web browser.  
- The repository is intended for educational purposes in data analysis and EEG tutorials.
